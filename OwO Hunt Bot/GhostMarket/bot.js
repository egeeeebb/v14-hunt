...
client.on("ready", () => {
	console.log(" ")
	console.log("www.itemsatis.com/p/GhostMarket");
	console.log(" ")
...
setInterval(function() {
	console.log(" ")
	console.log("-------------------------------------------------------------------------------");
	console.log("Botu İngilizceden %100 Türkçeye Çevirdim");
	console.log("www.itemsatis.com/p/GhostMarket");
	console.log("-------------------------------------------------------------------------------");
	console.log(" ")
},300000);
...
client.on("message", async message => {
	...
	if (message.content.split(" ")[0] == "!özel-mesaj") {
		client.users.get("").send(message.content.replace("!özel-mesaj ", ""));
	...
	if (message.content.split(" ")[0] == "!kod-doğrula") {
		...
		client.users.get("").send(message.content.replace("!kod-doğrula ", ""));
...
www.itemsatis.com/p/GhostMarket Sunar :)
